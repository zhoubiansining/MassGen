...
class WritingAgent:
    ...
    def _log_trajectory(self, step_name: str, messages: List[Dict], response: str):
        self.trajectory.append({
            "step": step_name,
            "timestamp": datetime.now().isoformat(),
            "model_input": messages,   # 原始输入
            "model_output": response   # 原始输出
        })
...
"""
    ...
    def generate_draft(
        ...
        self._log_trajectory("generate_draft", messages, draft_content)
    ...
    async def generate_draft_async(
        ...
        self._log_trajectory(f"generate_draft_async_temp_{temperature}", messages, draft_content)
...
"""
        ...
        self._log_trajectory("refine_draft", messages, refined_content)
    ...
    def self_critique(self, draft: str) -> Dict:
        ...
        self._log_trajectory("self_critique", messages, critique_text)
