...
from agents.writing_agent import WritingAgent, ModelConfig
...
async def main():
    ...
    try:
        ...
        save_json(writer.trajectory, TRAJ_DIR, "writing_traj")
    ...
    try:
        ...
        save_json(judge.trajectory, TRAJ_DIR, "judge_eval_traj")
    ...
    try:
        ...
        save_json(judge.trajectory, TRAJ_DIR, "judge_verify_traj")
